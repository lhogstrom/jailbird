...
#  3. Annotate each components by matching genomic features to it
   ...
   outpath <- "/xchip/cogs/projects/NMF/MCF7_comp_annot"
   ...
   DISSECTOR_make_heatmap_of_matrix.v1(
      ...
      annot_file               = c(paste(path1,"/MCF7_top_intra_connecting_compound_classes.v2.txt",sep=""),"CCLE_name", "Site.Primary", F), # Phenotype annotation file (TXT, optional) in format c(file, name_column, annot_column, use_prefix)
