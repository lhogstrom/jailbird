...
############################################################################################################
  ...
  # Pre-processing: rank normalization for CC datasets
   ...
   ##  CMAP Compound Classes ----------------------------------------------------------------------------------------------------------  
      # Input Files
      L1000.file   <- "~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes_n83x978.NORM.gct"
      L1000.file2  <- "~/CGP2013/TA/CC/MCF7_top_intra_connecting_compound_classes_n79x978.NORM.gct"
      annot.file   <- "~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes.v2.txt"
      # Parameters
      ...
      # Output Files
      pdf.file     <- paste("~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes_n83x978.", "k", k.comp, ".pdf", sep="")
      W.file       <- paste("~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes_n83x978.W.", "k", k.comp, ".gct", sep="")
      H.file       <- paste("~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes_n83x978.H.", "k", k.comp, ".gct", sep="")
      H2.file      <- paste("~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes_n83x978.H2.", "k", k.comp, ".gct", sep="")
      movie.file   <- paste("~/CGP2013/TA/CC/PC3_top_intra_connecting_compound_classes_n83x978.Biplot.Movie.", "k", k.comp, ".gct", sep="")
   ##  --------------------------------------------------------------------------------------------------------------------------------------------

   ##  Target Accelerator Ref / 4 pathways ----------------------------------------------------------------------------------------------------------  
      # Input Files
#      L1000.file           <- "~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_A375_72H_20131012.NORM.gct"  # Main input L1000 file
#      L1000.file2          <- "~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_PC3_72H_20131012.NORM.gct"   # Second input L1000 file
#      annot.file   <- "~/CGP2013/TA/TA_PATHWAYS/TARef_v2_Yash_20130507.txt"   # File with class or category annotations
      # Parameters
#      k.comp       <- 7    # Optimal number of components from consensus analysis: 7, 11, 22 or 35.
#      name.column  <- 1     # Column # in annot.file containing the perturbation name
#      class.column <- 3     # Column # in annot.file containing the class or category name
#      use.prefix   <- T     # Use only prefix before "_" to find association between perturbation names in Input File vs. annot.file
#      n.top        <- 35         # Number of top/highest IC associations to display in heatmap
#      n.bottom     <- 10      # Number of bottom/lowest IC associations to display in heatmap
      # Output Files
#      pdf.file     <- paste("~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_A375_72H_20131012.", "k", k.comp, ".pdf", sep="")
#      W.file       <- paste("~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_A375_72H_20131012.W.", "k", k.comp, ".gct", sep="")
#      H.file       <- paste("~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_A375_72H_20131012.H.", "k", k.comp, ".gct", sep="")
#      H2.file      <- paste("~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_A375_72H_20131012.H2.", "k", k.comp, ".gct", sep="")
#      movie.file   <- paste("~/CGP2013/TA/TA_PATHWAYS/TAref4pathways_OE_L1000_NMF_TA.OE003_A375_72H_20131012.Biplot.Movie.", "k", k.comp, ".gct", sep="")
   ##  --------------------------------------------------------------------------------------------------------------------------------------------
...
#      movie.file   <- paste("~/CGP2013/TA/Oncogenic/signatures.QNORM_collapsed_to_symbols.Biplot.Movie.", "k", k.comp, ".gct", sep="")
   ...
   source("~/CGP2013/CNMF/CNMF.4.R")
   source("~/CGP2011/ssGSEA/benchmarks/OPAM.library.v7.R")   
   source("~/CGP2013/FS/FS.library.v8.6.R")     
