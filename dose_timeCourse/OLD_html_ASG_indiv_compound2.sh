...
# 	echo "<h1><CENTER>compound = $CMPD<CENTER></h1> <tr><td><img src=$OUTPATH/PC3_sigs/ssCCplots_6H/thumb600/$CMPD.png></td><td><img src=$OUTPATH/PC3_sigs/ssCCplots_24H/thumb600/$CMPD.png></td></tr><tr><td><img src=$OUTPATH/MCF7_sigs/ssCCplots_6H/thumb600/$CMPD.png></td><td><img src=$OUTPATH/MCF7_sigs/ssCCplots_24H/thumb600/$CMPD.png></td></tr>" >> $OUTPATH/$OUTFILE
	#alt ss calculation	
	echo "<h1><CENTER>compound = $CMPD<CENTER></h1> <tr><td><img src=PC3_6H_${CMPD}_ssCCplot.jpg></td><td><img src=PC3_24H_${CMPD}_ssCCplot.jpg></td></tr><tr><td><img src=MCF7_6H_${CMPD}_ssCCplot.jpg></td><td><img src=MCF7_24H_${CMPD}_ssCCplot.jpg></td></tr>" >> $OUTPATH/$OUTFILE
	
	echo "<BR>" >> $OUTPATH/$OUTFILE

	#print matlab figs
	echo "<h1><CENTER>compound = $CMPD<CENTER></h1> <tr><td><img src=PC3_6H_${CMPD}_top_genes.jpg></td><td><img src=PC3_24H_${CMPD}_top_genes.jpg></td></tr><tr><td><img src=MCF7_6H_${CMPD}_top_genes.jpg></td><td><img src=MCF7_24H_${CMPD}_top_genes.jpg></td></tr>" >> $OUTPATH/$OUTFILE
