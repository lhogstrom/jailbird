%% load infered data - VC - vehicle control
    %PC3 6H
...
%% load in infered data - PC - plate controled 
...
%% set info about setup
    ...
    outdir = '/xchip/cogs/projects/ASG_dose_time/cmap_queries/PC3_sigs';
    outnameUP = sprintf('%s_%s_signatures_up.gmt',cellLine,timeP);
    outnameDN = sprintf('%s_%s_signatures_dn.gmt',cellLine,timeP);
